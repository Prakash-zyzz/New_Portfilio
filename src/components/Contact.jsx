        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
          <div className='flex justify-center'>
            <div>
              ...
              <form method='POST' action="https://getform.io/f/1ff721c4-0000-4e8f-aa68-1d74d53ace19" className='flex flex-col w-full py-8'>

              <input className='bg-[#999999] w-full sm:w-96 px-2 py-2 rounded-sm' type="text" placeholder='Name' name='name' />
              <input className='my-4 py-2 bg-[#999999] w-full sm:w-96 px-2 rounded-sm' type="email" placeholder='Email' name='email' />
              <textarea className='bg-[#999999] w-full sm:w-200 px-2 py-2 border rounded-sm' name="message" rows="10" placeholder='Message'></textarea>
